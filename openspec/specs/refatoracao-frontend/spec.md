# refatoracao-frontend Specification
...
A página MUST NOT fazer a resolução e fetch server-side usando Server Components de forma que mascare o papel do cliente como a entidade primária consumindo a aplicação web.
...
Os processos de buscar listas amplas MUST ser guiados por paginação nativa (limit/offset ou cursor) oriunda do controle no cliente.
