...
As entidades de domínio devem encapsular suas lógicas e regras essenciais de negócio.
...
A arquitetura base deve fornecer uma interface ou classe base para as características da IA, em `domain/`.
...
A lógica não deve "vazar" em routers.
