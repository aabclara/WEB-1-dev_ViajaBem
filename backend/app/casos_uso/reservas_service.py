...
class ReservasService:
    ...
    async def criar_slots_passageiros(
        self, reserva: ReservaGrupo, nome_lider: str
    ) -> List[Passageiro]:
    ...
    async def criar_reserva(
        self, id_viagem: int, id_lider: int, qtd_vagas: int, nome_lider: str
    ) -> ReservaGrupo:
        from app.repositorios.reserva_repositorio import (
            ViagemRepositorio,
            ReservaRepositorio,
        )
